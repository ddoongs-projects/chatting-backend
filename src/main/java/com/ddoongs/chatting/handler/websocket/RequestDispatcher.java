...
public class RequestDispatcher {
  ...
  public <T extends BaseRequest> void dispatchRequest(
    ...
    BaseRequestHandler<T> handler =
        (BaseRequestHandler<T>) handlerMap.get(request.getClass());
  ...
  private void prepareRequestHandlerMapping() {
    Map<String, BaseRequestHandler> beanHandlers = listableBeanFactory.getBeansOfType(
